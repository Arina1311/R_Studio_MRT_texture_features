...
#------------ BENDRA ATRINKTŲ POŽYMIŲ LENTELĖ -------------------------
...
# -----------Duomenų paruošimas klasifikavimui ------------
...
# Klasių pasiskirstymo patikrinimas
...
# ------------------ KLASIFIKAVIMO METRIKŲ VERTINIMAS -------------
...
# Modelių treniravimas visoms struktūroms ------------
...
# Metrikų ištraukimas iš geriausio hiperparametrų rinkinio -----------------
...
# Geriausias modelis kiekvienai struktūrai -------------------
...
get_patient_level_confusion_matrix <- function(
  ...
  # Sukuriame Patient_ID lentele pagal rowIndex
...
# ---------- Galutinis modelis ant visų duomenų ----------
# Šis etapas skirtas ne validavimui, o galutinių modelių apmokymui,
# naudojant geriausius hiperparametrus, rastus per repeated CV.
...
# --------- Požymiai, kurie atrinkti daugiau nei 2 struktūrose -----------
...
# Visų struktūrų sujungimas į vieną long formato lentelę
...
# Patikrinimas, ar nėra Patient_ID leakage tarp train ir validation -----------
...
# Modelių treniravimas jungtiniam visų struktūrų rinkiniui
...
# Metrikų ištraukimas jungtiniams modeliams -----------------
